...
public class CreateSequentialFile {
	...
	public void addRecords() {
		...
		System.out.printf("%s%s", "Enter account number (> 0), first name, last name and balance.", "? :");
		while (input.hasNext()) {
			try 
			{
			...
			System.out.printf("%s %s %s", "Enter account number (>0),", "first name, last name and balance", "? :");
		} 
